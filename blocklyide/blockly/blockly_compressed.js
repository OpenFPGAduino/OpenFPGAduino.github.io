...
Blockly.Comment.prototype.setVisible = function(a) {
    if (a != this.isVisible())
        if (Blockly.Events.fire(new Blockly.Events.Ui(this.block_, "commentOpen", !a, a)), !this.block_.isEditable() && !this.textarea_ || goog.userAgent.IE) Blockly.Warning.prototype.setVisible.call(this, a);
            ...
            a ? (this.bubble_ = new Blockly.Bubble(this.block_.workspace, this.createEditor_(), this.block_.svgPath_, this.iconXY_, this.width_, this.height_), this.bubble_.registerResizeEvent(this, this.resizeBubble_),
...
Blockly.Connection.prototype.closest = function(a, b) {
...
Blockly.BlockSvg.prototype.onMouseUp_ = function(a) {
    ...
    Blockly.selected && Blockly.highlightedConnection_ ? (Blockly.localConnection_.connect(Blockly.highlightedConnection_), this.rendered && (Blockly.localConnection_.isSuperior() ? Blockly.highlightedConnection_ : Blockly.localConnection_).getSourceBlock().connectionUiEffect(),
        this.workspace.trashcan && this.workspace.trashcan.close()) : !this.getParent() && Blockly.selected.isDeletable() && this.workspace.isDeleteArea(a) && ((a = this.workspace.trashcan) && goog.Timer.callOnce(a.close, 100, a), Blockly.selected.dispose(!1, !0), Blockly.fireUiEvent(window, "resize"));
...
Blockly.BlockSvg.prototype.onMouseMove_ = function(a) {
    if (!("mousemove" == a.type && 1 >= a.clientX && 0 == a.clientY && 0 == a.button)) {
        ...
        if (Blockly.dragMode_ ==
            ...
            for (var d = this.getConnections_(!1), e = null, f = null, g = Blockly.SNAP_RADIUS, c = 0; c < d.length; c++) {
                var h = d[c],
                    k = h.closest(g, b);
                k.connection && (e = k.connection, f = h, g = k.radius)
            }
            Blockly.highlightedConnection_ &&
                Blockly.highlightedConnection_ != e && (Blockly.highlightedConnection_.unhighlight(), Blockly.highlightedConnection_ = null, Blockly.localConnection_ = null);
...
Blockly.Flyout.prototype.position = function() {
    if (this.isVisible()) {
        ...
        if (a) {
            ...
            this.RTL && (b *= -1);
            this.setBackgroundPath_(b, a.viewHeight);
            b = a.absoluteLeft;
...
Blockly.Flyout.prototype.setBackgroundPath_ = function(a, b) {
    ...
    c.push("v", Math.max(0, b - 2 * this.CORNER_RADIUS));
    c.push("a", this.CORNER_RADIUS, this.CORNER_RADIUS, 0, 0, this.RTL ? 0 : 1, this.RTL ? this.CORNER_RADIUS : -this.CORNER_RADIUS, this.CORNER_RADIUS);
    c.push("h", -a);
    c.push("z");
...
Blockly.Flyout.prototype.show = function(a) {
    ...
    for (var c = [], d = [], e = this.permanentlyDisabled_.length = 0, f; f = a[e]; e++)
        if (f.tagName && "BLOCK" == f.tagName.toUpperCase()) {
            ...
            d.push(isNaN(f) ? 3 * b : f)
        }
    this.layoutBlocks_(c, d, b);
...
Blockly.Flyout.prototype.layoutBlocks_ = function(a, b, c) {
    for (var d = c, e = 0, f; f = a[e]; e++) {
        for (var g = f.getDescendants(), h = 0, k; k = g[h]; h++) k.isInFlyout = !0;
        f.render();
        g = f.getSvgRoot();
        h = f.getHeightWidth();
        f.moveBy(this.RTL ? 0 : c / this.workspace_.scale + Blockly.BlockSvg.TAB_WIDTH, d);
        d += h.height + b[e];
...
Blockly.Flyout.prototype.placeNewBlock_ = function(a, b) {
    var c = Blockly.Xml.blockToDom(a),
        c = Blockly.Xml.domToBlock(c, b),
        d = a.getSvgRoot();
    if (!d) throw "originBlock is not rendered.";
    d = Blockly.getSvgXY_(d, b);
    if (this.RTL) {
        var e = b.getMetrics().viewWidth - this.width_;
        d.x += e / b.scale - e
    } else d.x += this.workspace_.scrollX / this.workspace_.scale - this.workspace_.scrollX;
    d.y += this.workspace_.scrollY / this.workspace_.scale - this.workspace_.scrollY;
    e = c.getSvgRoot();
    ...
    b.toolbox_ && !b.scrollbar && (e.x += b.toolbox_.width / b.scale);
